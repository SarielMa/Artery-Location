...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_weights", type=str,default = "checkpoints/yolov3_ckpt_90.pth", help="if specified starts from checkpoint model")
    ...
    plt.plot(means)
    plt.savefig("160_2xbbox_mdis.png")
